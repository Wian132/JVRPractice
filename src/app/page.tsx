...
export default function Home() {
  const [summary] = React.useState<string | null>(
    `Patients consistently praise Dr. Van Rooyen for being an excellent, skilled, and compassionate orthopedic surgeon who takes time to listen and explain treatment options. His extensive experience and commitment to patient care are highly respected.`
  );
  ...
  return (
    <main>
      ...
      <section
        ...
        className="py-16 md:py-20 bg-cover bg-center bg-slow-zoom scroll-mt-24 md:scroll-mt-32"
                  ...
                  <form className="flex flex-col gap-4" onSubmit={handleFormSubmit} noValidate>
                    <div>
                      ...
                      <Input
                        ...
                        required
                        className="bg-white/80 border-gray-400 text-black placeholder:text-black/70"
                        value={formData.name}
                    ...
                    <div>
                      <label htmlFor="reason" className="block text-sm font-medium text-gray-700 mb-1">
                        Brief reason for appointment <span className="text-gray-500">(optional)</span>
                      </label>
                      <Textarea
                        id="reason"
                        name="reason"
                    ...
                    {submitStatus && (
                      <p
                        role="alert"
                        className={`mt-2 text-sm font-medium ${submitStatus.type === 'success' ? 'text-green-700' : 'text-red-700'}`}
                      >
      ...
      <motion.section
        ...
        className="relative py-16 md:py-20 bg-cover bg-center bg-fixed overflow-hidden scroll-mt-24 md:scroll-mt-32"
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <h2 id="about-heading" className="text-3xl md:text-4xl font-semibold text-center mb-10 md:mb-12 text-white">
            About The Practice & Patient Experiences
          </h2>
            ...
            <Card className="bg-[#F5F5DC]/90 backdrop-blur-sm shadow-xl h-full flex flex-col">
              <CardHeader className="text-center">
                ...
                <CardDescription className="text-gray-700">
                  Dedicated to providing exceptional orthopedic care in Nelspruit.
                </CardDescription>
              </CardHeader>
          ...
          <h3 id="testimonials" className="text-3xl md:text-4xl font-semibold text-center mt-16 mb-10 md:mb-12 text-white">
